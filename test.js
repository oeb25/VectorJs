...
describe('Vector', function() {
	describe('Construction', function() {
		...
		it("should return a vector when new is't present", function() {
		...
		describe('default paramertes', function() {
			...
			it("should use x as y, if y isn't present", function() {
				assert.equal(b.x, b.y);
			});

			it("shouldn't default to 0 if x is present", function() {
	...
	describe('Helpers', function() {
		...
		describe('#clone()', function() {
			...
			it("shouldn't return the object it self", function() {
		...
		describe('#equals()', function() {
			...
			it("shouldn't return true when the vectors are diffrent", function() {
	...
	describe('Math', function() {
		...
		describe('#angle()', function() {
			...
			it('should return the same from #angle() and #angleRad() but in rad and deg', function() {
